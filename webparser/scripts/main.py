...
def run():
    ...
    # link = "https://courses.illinois.edu/cisapp/dispatcher/schedule/2014/spring/CS/418"
    # scrape = SoupParser.Parser(html, 0, "test")
    # scrape = SoupParser.Parser(link, 1, "testURL")


    dept_link = "https://courses.illinois.edu/cisapp/dispatcher/catalog/2014/spring/ACE"
